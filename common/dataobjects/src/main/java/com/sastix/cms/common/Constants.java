...
public interface Constants {
     ...
     */
    static String GET_ALL_RESOURCES = "getAllResources";
    static String GET_RELEVANT_REVISIONS = "getRelevantRevisions";
    static String SEND_EMAIL_ATTACHMENT = "sendEmailAttachment";
